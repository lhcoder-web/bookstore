    ...
    <scroll class="content-wrapper"
      ...
      <div class="book-speak-title-wrapper">
        ...
        <div class="speak-title-wrapper">
          <span class="speak-title">语言朗读</span>
        </div>
      ...
      <div class="book-detail-content-wrapper" v-show="ifShowContent">
        <div class="book-detail-content-list-wrapper">
          <div class="loading-text-wrapper" v-if="!this.navigation">
            <span class="loading-text">详情加载</span>
          </div>
...
<script type="text/ecmascript-6">
  ...
  import speakWindow from '../../components/speak/SpeakWindow'
  import { findBook, getCategoryName } from '../../utils/store'
  import { flatList } from '../../network/index'
 ...
 const app_Secret = 'GiE5X7aQUYd5vvaiEe0m9ymCn1w6p1y2';
  ...
  export default {
    ...
    methods: {
      ...
      play() {
        ...
        this.$refs.audio.src = `http://tsn.baidu.com/text2audio?lan=zh&ctp=1&cuid=abcdxxx&tok=24.e4587a8b118fc0812c8a072224a02b5f.2592000.1587790204.282335-19088134&tex=${this.text}`
